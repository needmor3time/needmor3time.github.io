...
var wordGuessGame = {
  ...
  updateGuesses: function (letter) {
    ...
    if ((this.guessedLetters.indexOf(letter) === -1) && (this.lettersOfTheWord.indexOf(letter) === -1)) {
      ...
      $("#guesses-remaining").html(this.guessesLeft);
      $("#guessed-letters").html(this.guessedLetters.join(", "));
    }
  },
  ...
  updateWins: function () {
    ...
    if (win) {
      ...
      $("#music").html(this.wordsToPick[this.wordInPlay].song + " By " + this.wordInPlay);

      // Update the image of the band on the page.
      $("#bandDiv").html("<img class='band-image' src='../images/" +
